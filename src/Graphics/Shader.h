...
class Shader {
  public:
    ...
    Shader(std::string vertexPath,
           ...
           std::optional<std::string> tessControlPath = std::nullopt,
        ...
        try {
            ...
            if (geometryPath) {
                gShaderFile.open(geometryPath.value());
            ...
            if (tessControlPath) {
                tcShaderFile.open(tessControlPath.value());
            ...
            if (tessEvalPath) {
                teShaderFile.open(tessEvalPath.value());
